  ...
  <body>
          ...
          <div class="navbar-inner">
            ...
            <div class="nav-collapse collapse">
              ...
              <form class="navbar-form pull-right">
                <input class="span2" type="text" placeholder="Correo">
    ...
    <div id="myCarousel" class="carousel slide">
      <div class="carousel-inner">
        <div class="item active">
          <img src="<?=base_url()?>/assets/img/examples/slide-01.jpg" alt="">
          <div class="container">
        ...
        <div class="item">
          <img src="<?=base_url()?>/assets/img/examples/slide-02.jpg" alt="">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="item">
          <img src="<?=base_url()?>/assets/img/examples/slide-03.jpg" alt="">
          <div class="container">
            <div class="carousel-caption">
    ...
    <div class="container marketing" id="nosotros">
      ...
      <div class="row">
        ...
        <div class="span4">
          <img class="img-circle" data-src="holder.js/140x140">
          <h2>Recibe recomendaciones</h2>
          <p>Se te harán sugerencias en base a tus preferencias alimenticias.</p>
          <p><a class="btn" href="#">View details &raquo;</a></p>
        </div><!-- /.span4 -->
        <div class="span4">
          <img class="img-circle" data-src="holder.js/140x140">
          <h2>Agenda citas</h2>
          <p>puedes agendar citas con nutriólogos certíficados que te darán atención personalizada.</p>
          <p><a class="btn" href="#">View details &raquo;</a></p>
        </div><!-- /.span4 -->
      </div><!-- /.row -->
      ...
      <div class="featurette">
        <img class="featurette-image pull-right" src="<?=base_url()?>/assets/img/examples/browser-icon-safari.png">
